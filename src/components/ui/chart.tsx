...
type DefaultTooltipProps = React.ComponentProps<typeof DefaultTooltipContent>
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item: TooltipPayload, index: number) => {
            ...
            const fill =
              typeof original?.fill === "string" ? original.fill : undefined
    ...
    return (
      ...
      >
        {payload.map((item, idx) => {
          ...
          // Reutilizamos tu helper; si TS se queja aquí por el tipo, lo ajustamos en 1 línea
          const itemConfig = getPayloadConfigFromPayload(config, item as unknown as TooltipPayload, key)
