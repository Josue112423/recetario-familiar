...
type DayPickerComponents = NonNullable<DayPickerComponentProps["components"]>
type ChevronComponent = NonNullable<DayPickerComponents["Chevron"]>
type ChevronProps = Parameters<ChevronComponent>[0]
